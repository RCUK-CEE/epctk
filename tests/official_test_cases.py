...
"EW-3g -EndTerrace-LPG warm air and decorative bottled gas fire.rtf", # different offpeak fraction for mech vent fans?
...
"EW-4L - mid-terrace _community  Heatpump with cylinder in dwelling and Solar.rtf", # community heating - TER fuel factor,etc
...
"EW-8e- semi existing - with multi-system heating - heatpump 100073  and gas boiler_DHW from 1st.rtf",# PCDF heat pump
...
"EW-9c- mCHP - oil - service 1 vessel 1 - tests database 492023.rtf", # fan and pump gain is odd?
