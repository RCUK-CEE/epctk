...
Import the relevant functions as needed by other parts of epctk.
...
from .tables_appendix_n import (table_n4_heating_days, table_n8_secondary_fraction, interpolate_psr_table,
